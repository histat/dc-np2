...
#else
#define	_FILEH				TMPFILEH
#define	_FILEH_INVALID		TMPFILEH_INVALID
#define	_FSEEK_SET			FSEEK_SET
#define _file_open_rb		tmpfile_open_rb
#define _file_create		tmpfile_create
#define	_file_read			tmpfile_read
#define	_file_write			tmpfile_write
#define	_file_seek			tmpfile_seek
#define	_file_close			tmpfile_close
#endif
